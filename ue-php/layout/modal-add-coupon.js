document.writeln(`
<!-- --------------- modal add kupon -->
<div id="modal-add-coupon" class="modal" tabindex="-1">
      ...
      <div class="modal-content border-primary border-3">
         ...
         <div class="modal-body">
            <p class="text-center fs-5">
               Selamat, Anda mendapatkan 1 E-Ticket <br class="d-none d-lg-inline"> <b class="fw-medium">Uang Emas goes to Mekah</b>.
            </p>
