...
--
-- Host: localhost
-- Generation Time: Mar 19, 2025 at 02:57 AM
...
(6, NULL, 'nosugar', 'coffee & creamer', '12', ' instant coffee drink mochaccino flavor ', 'minuman kopi instan rasa mochaccino', 'sugar, non dairy creamer, instant coffee, maltodextrin, milk powder, cocoa powder, salt, synthetic vanilla flavor ', 'gula, krimer nabati, kopi instan, maltodekstrin, susu bubuk, kakao bubuk, garam, perisa sintetik vanilla', 'assets/img/nosugar-creamer-1.png', 'assets/img/nosugar-creamer-1.png', 'assets/img/nosugar-creamer-1.png', '#00a5e3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, NULL, 'nosugar', 'cappuccino', '12', ' instant coffee drink mochaccino flavor ', 'minuman kopi instan rasa mochaccino', 'sugar, non dairy creamer, instant coffee, maltodextrin, milk powder, cocoa powder, salt, synthetic vanilla flavor ', 'gula, krimer nabati, kopi instan, maltodekstrin, susu bubuk, kakao bubuk, garam, perisa sintetik vanilla', 'assets/img/nosugar-cappuccino-1.png', 'assets/img/nosugar-cappuccino-1.png', 'assets/img/nosugar-cappuccino-1.png', '#76543c', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, NULL, 'pure', 'special', '7', 'special coffee', 'kopi spesial', '100% pure coffee', '100% kopi murni', 'assets/img/pure-renceng-1.png', 'assets/img/pure-renceng-2.png', 'assets/img/pure-renceng-3.png', '#252525', NULL, NULL, '', '', '', '', '', NULL, NULL, NULL),
(9, NULL, 'pure', 'special', '150', 'special coffee', 'kopi spesial', '100% pure coffee', '100% kopi murni', 'assets/img/pure-gusset-1.png', 'assets/img/pure-gusset-2.png', 'assets/img/pure-gusset-3.png', '#252525', NULL, NULL, '', '', '', '', '', NULL, NULL, NULL),
(10, NULL, 'pure', 'special', '140', 'special coffee', 'kopi spesial', '100% pure coffee', '100% kopi murni', 'assets/img/pure-bag-1.png', 'assets/img/pure-bag-2.png', 'assets/img/pure-bag-3.png', '#252525', NULL, NULL, '', '', '', '', '', NULL, NULL, NULL);
